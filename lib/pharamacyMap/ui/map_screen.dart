...
import 'package:medication_remainder/pharamacyMap/apis/api_manager.dart';
import 'package:medication_remainder/pharamacyMap/constants/api_constants.dart';
import 'package:medication_remainder/pharamacyMap/constants/file_constants.dart';
import 'package:medication_remainder/pharamacyMap/constants/key_constants.dart';
import 'package:medication_remainder/pharamacyMap/constants/space_constants.dart';
import 'package:medication_remainder/pharamacyMap/location/location_manager.dart';
...
import 'package:medication_remainder/pharamacyMap/utils/permission_utils.dart';
...
class _MapScreenState extends State<MapScreen> {
  ...
  final List<PharmacyDetailsModel> _pharmacies = [];
    ...
    ApiManager()
        .getPlaces(
            ApiConstants.getPlaces(
                ...
                "AIzaSyDbtJ1dV_G9nvMNo_Eh2PMRZgJR7tgUvm8"),
            context)
        .then((value) {
      setState(() {
  ...
  void _setMarkerUi(List<PharmacyDetailsModel> listOfPharmacy) async {
    List<MapMarker> generatedMapMarkers = [];
    for (var element in listOfPharmacy) {
      ...
      generatedMapMarkers.add(MapMarker(
          id: element.placeId,
